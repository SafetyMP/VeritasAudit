...
- **Loop Limit:** If a runtime installation, environment path configuration, or `mise` command fails consecutively 3 times during toolchain setup, the agent MUST immediately cease execution loops.
