...
- **Loop Limit:** If a Docker build, container mounting, or workspace virtualization command fails consecutively 3 times during setup or initialization, the agent MUST immediately cease execution loops.
